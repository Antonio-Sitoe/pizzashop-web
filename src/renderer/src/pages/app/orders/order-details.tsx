...
export function OrderDetails({ id, isOpen }: OrderDetailsProps): JSX.Element {
          ...
          <Table>
            <TableBody>
              ...
              <TableRow>
                ...
                <TableCell className="flex justify-end">{order?.customer?.name || 'N/A'}</TableCell>
              </TableRow>
              <TableRow>
              ...
              {order.orderItems.map((items) => {
                return (
                  <TableRow key={items.id}>
                    ...
                    <TableCell className="text-right">
                      {((items.quantity * items.priceInCents) / 100).toLocaleString('pt-BR', {
                        style: 'currency',
                        currency: 'BRL'
                      })}
                    </TableCell>
